# Eine rein prozedurale Version von Snake
# Quelle: https://github.com/Carla-Codes/simple-snake-game-python/blob/main/snake.py
# - keine Unterprogramme
# - keine Klassen
# - keine Konstanten
# - Aber es funktioniert!!!

# Minimale Anpassungen: Michael Brenner
# - Integer-Divisionen durch "//" ersetzt
